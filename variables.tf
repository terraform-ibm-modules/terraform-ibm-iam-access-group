...
variable "resource_tags" {
  type        = list(string)
  description = "Add user resource tags to the IAM Access Group to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types)."
  default     = []
  validation {
