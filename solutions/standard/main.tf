module "access_groups" {
  ...
  resource_tags = var.admin_observability_ag_tags
  ...
  resource_tags = var.admin_security_ag_tags
  ...
  resource_tags = var.admin_network_ag_tags
  ...
  resource_tags = var.admin_compute_ag_tags
  ...
  resource_tags = var.privileged_observability_ag_tags
  ...
  resource_tags = var.privileged_security_ag_tags
  ...
  resource_tags = var.privileged_network_ag_tags
  ...
  resource_tags = var.privileged_compute_ag_tags
  ...
  resource_tags = var.observer_observability_ag_tags
  ...
  resource_tags = var.observer_security_ag_tags
  ...
  resource_tags = var.observer_network_ag_tags
  ...
  resource_tags = var.observer_compute_ag_tags
}
